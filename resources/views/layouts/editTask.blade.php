...
@section('main')
	...
	<div class="formContainer">
		<form action="{{route('updateTask', $tdo->id)}}" method="POST" class="form">
			@csrf
			<input type="text" name="name" id="name" class="addTaskInput addTaskInputName" value="{{$tdo->name}}">
			<input type="datetime-local" name="date" id="date" class="addTaskInput addTaskInputDate" placeholder="Enter a Date">
			<input type="submit" id="addTaskBtn" class="btnAdd hvr-wobble-horizontal" value="Update">
		</form>
